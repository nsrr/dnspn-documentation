BDC NSRR Disrupted Nighttime Sleep in Pediatric Narcolepsy (DNSPN)
...
o 3-minute psychomotor vigilance task (PVT).
o A spatial declarative memory task before habitual bedtime.
o Underwent repeat PVT in the morning, memory task retest 
o Subgroup completed alternate declarative memory task in morning to assess circadian influences.
o Urine drug screening to confirm drug-free status.
...
o Obstructive apneas: ≥90% airflow reduction for duration of ≥2 missed breaths; associated with continued/increased inspiratory effort.
o Central apneas: absence of thoracic and abdominal effort.
o Hypopneas: ≥50% airflow reduction lasting ≥2 missed breaths, with ≥3% desaturation or arousal/awakening.
o Mixed apneas: initial central apnea followed by obstructive component; duration ≥2 missed breaths.
...
Citation
Maski K, Heckler G, Worhach J, Mylonas D, Wang G, Szilagyi K, Zhang B, Diniz Behn C, Scammell TE, Stickgold R. Impaired Sleep-Dependent Memory Consolidation in Pediatric Narcolepsy Type 1. Sleep. 2024 Oct 18:zsae238. doi: 10.1093/sleep/zsae238. Epub ahead of print. PMID: 39420719.
...
• Primary publication: Maski et al., 2024; DOI: 10.1093/sleep/zsae238
• NSRR resource citation: Zhang et al., 2018; DOI: 10.1093/jamia/ocy064
